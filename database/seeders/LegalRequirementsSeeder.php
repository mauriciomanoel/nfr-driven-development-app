...
class LegalRequirementsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            ...
            'description' => "<p>O sistema AAL deve cumprir as disposições do RGPD em relação à coleta, processamento e armazenamento de dados pessoais. Isso inclui obter o consentimento adequado dos usuários para o uso de seus dados, garantir a segurança e a privacidade desses dados, e possibilitar que os usuários acessem, retifiquem e excluam suas informações pessoais.</p>",
        ...
        $requirements = NonFunctionalRequirements::whereIn('name', ['Security', 'Privacy', 'Confidentiality', 'Acceptability', 'Ethics', 'Autonomy'])->get();
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            ...
            'description' => "<p>O sistema AAL deve ser projetado e desenvolvido levando em consideração os princípios de acessibilidade, garantindo que seja utilizável por pessoas com diferentes níveis de habilidades e capacidades. Isso inclui a implementação de recursos e funcionalidades que permitam o acesso e a interação por parte de pessoas com deficiência, como pessoas com deficiência visual, auditiva, motora ou cognitiva.</p>",
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            ...
            'description' => "<p>O sistema AAL deve ser projetado e implementado de acordo com os padrões e regulamentos de segurança aplicáveis, garantindo a integridade e confiabilidade do sistema. O objetivo é proteger informações confidenciais, impedir o acesso não autorizado e mitigar possíveis riscos e ameaças à segurança.</p>",
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            'name' => "Usability",
            'description' => "<p>O sistema AAL deve ser projetado considerando os princípios de usabilidade, facilitando seu uso pelos usuários independentemente de suas habilidades técnicas. Usabilidade refere-se à medida em que um sistema pode ser usado por usuários específicos para atingir objetivos específicos com eficácia, eficiência e satisfação em um contexto específico de uso.</p>",
            'legal_references' => "
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            ...
            'description' => "<p>A norma ISO/IEC 25066:2016 é uma parte da série ISO/IEC 25000, que trata da avaliação de qualidade de produtos de software. Especificamente, a ISO/IEC 25066 estabelece requisitos para a documentação de produtos de software, com o objetivo de garantir que a informação fornecida seja adequada, precisa e útil para os usuários finais, desenvolvedores e outros stakeholders envolvidos no ciclo de vida do software.</p>",
        ...
        $legalAndNormativeRequirement = LegalRequirements::create([  
            ...
            'description' => "<p>ISO/TR 21332:2021 is a technical report in the field of health informatics. It focuses on providing considerations and guidelines for the security and privacy aspects of health information systems when using cloud computing technologies. The report addresses the unique challenges and opportunities related to adopting cloud computing in the healthcare industry while safeguarding the confidentiality, integrity, and availability of health information.The technical report offers insights into best practices, risk management, and security measures that healthcare organizations should consider when migrating or deploying health information systems in cloud environments.</p>",
