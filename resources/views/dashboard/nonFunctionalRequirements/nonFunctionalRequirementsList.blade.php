              ...
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                @endif                  
                    <div class="card-header">
                      <i class="fa fa-align-justify"></i>{{ __('Non-Functional Requirements') }}</div>
                    <div class="card-body">
                        <div class="row"> 
                          <a href="{{ route('nonFunctionalRequirements.create') }}" class="btn btn-primary m-2">{{ __('Add Non-Functional Requirement') }}</a>
                        </div>
                        <br>
