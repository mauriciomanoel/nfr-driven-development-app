...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/rs4aal-base-white.svg') }}" width="118" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/rs4aal-signet-white.svg') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
